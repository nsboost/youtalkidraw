...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/youtalkidraw)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/youtalkidraw
```

A live public deployment of this template is available at [https://youtalkidraw.templates.workers.dev](https://youtalkidraw.templates.workers.dev)
